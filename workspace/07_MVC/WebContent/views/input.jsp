...
<body>
	<form id='f'>
		<h3>도형의 면적 구하기</h3>
		<input type="text" name="width" placeholder="너비 입력" size="9"><br>
		<input type="text" name="height" placeholder="높이 입력" size="9"><br>
		<input type="text" name="radius" placeholder="반지름 입력" size="11"><br>
