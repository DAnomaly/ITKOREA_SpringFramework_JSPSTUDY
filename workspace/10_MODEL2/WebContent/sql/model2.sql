...
CREATE TABLE MEMBER_LOG (
	NO NUMBER, -- 기록번호
	ID VARCHAR2(32), -- 접속자의 ID
	IP VARCHAR2(20), -- 로그인 장소 IP
	LOGIN DATE, -- 로그인 일시
	LOGOUT DATE -- 로그아웃 일시
);
...
-- 데이터
INSERT INTO MEMBER VALUES (MEMBER_SEQ.NEXTVAL, 'admin', '123', '관리자', 'admin@home.com', SYSDATE);
INSERT INTO MEMBER VALUES (MEMBER_SEQ.NEXTVAL, 'staff', '123', '스텝', 'staff@home.com', SYSDATE);
INSERT INTO MEMBER VALUES (MEMBER_SEQ.NEXTVAL, 'bread', '123', '브레드', 'bread@naver.com', SYSDATE);
INSERT INTO MEMBER VALUES (MEMBER_SEQ.NEXTVAL, 'apple', '123', '애플', 'apple@naver.com', SYSDATE);
INSERT INTO MEMBER VALUES (MEMBER_SEQ.NEXTVAL, 'laffey', '123', '라피', 'laffey@naver.com', SYSDATE);
